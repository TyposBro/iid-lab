...
export const Footer = () => {
  return (
    <footer className="p-16 bg-[#231F20] grid grid-cols-2 grid-rows-2 gap-y-16 font-regular">
      {/* CTA */}
      <div className="flex flex-col gap-4">
        <h1 className="text-2xl text-white font-special text-[80px] font-bold leading-[72px] font-light">
